...
> 
> *Note: The code for this project was heavily developed with the assistance of Large Language Models (LLMs).*
...
* Restoring a chat creates a *new* conversation record on the server based on your local data; it does not undelete the original database row on the backend.
